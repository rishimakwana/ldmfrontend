...
import { Link as MuiLink, IconButton, Stack, Typography, Grid, FormControl, FormHelperText, InputLabel, Select, MenuItem, Box, Button, FormLabel, FormControlLabel, Checkbox, Autocomplete, TextField, Fade, CircularProgress, } from '@mui/material';
...
const RegisterComponent = () => {
  ...
  const handleNext = async () => {
    const stepFields = [
      ['fullName', 'gender', 'phone', 'email', 'password', 'confirmPassword', 'drivingLicenseFront', 'drivingLicenseBack'],
            ...
            <Grid item xs={12}>
              ...
              <Grid container spacing={2}>
                <Grid item xs={12} sm={6}>
                  <ImageField name='drivingLicenseFront' placeholder='Driving License Front' control={control} />
                </Grid>

                <Grid item xs={12} sm={6}>
                  <ImageField name='drivingLicenseBack' placeholder='Driving License Back' control={control} />
                </Grid>
              </Grid>
            </Grid>
        ...
        return (
          <>
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={6}>
                <InputField name='street' label='Street Address *' control={control} />
              </Grid>
  ...
  return (
    <>
      <Stack component='form' onSubmit={handleSubmit(onSubmit)} noValidate sx={style.box}>
        ...
        <Stack>
          <Image src='/images/ldmslogo.svg' alt="logo" className="client-logo" height={20} width={150} />
          <Box sx={style.header}>

            {activeStep > 0 && <Box onClick={handleBack}>
